  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
      ...
      <section style={{ marginBottom: '4rem', padding: '1.5rem', background: 'var(--surface-color)', borderRadius: '12px', border: '1px solid var(--border-color)' }}>
        ...
        <p>
          The atlas is a living document. If you identify a missing transformation or have better academic sources, please reach out to **komapc@gmail.com** or contribute directly via our **[GitHub Repository](https://github.com/komapc/a2a)** by clicking any empty cell in the matrix.
        </p>
      </section>
    </div>
  );
